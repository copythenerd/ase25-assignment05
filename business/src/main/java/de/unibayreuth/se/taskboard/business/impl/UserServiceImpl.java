...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public User create(@NonNull User user) throws MalformedRequestException, UserNotFoundException {
        if (user.getId() != null) {
    ...
    @Override
    public User upsert(User user) throws UserNotFoundException {
        if (user.getId() != null) {
    ...
    private void verifyUserExists(@org.springframework.lang.NonNull UUID id) throws UserNotFoundException {
